...
app.config["IMAGE_UPLOADS"] = "/home/afif1400/Documents/Development/Web Development/flask/prakshep-intern/images"
...
def upload_image():
    if request.method == "POST":
        if request.files:
            ...
            trainImg = imageio.imread('./images/'+image1.filename)
            trainImg_gray = cv2.cvtColor(trainImg, cv2.COLOR_RGB2GRAY)

            # queryImg = imageio.imread('http://www.ic.unicamp.br/~helio/imagens_registro/foto1B.jpg')
            queryImg = imageio.imread('./images/'+image2.filename)
            ...
            im.save(os.path.join(app.config["IMAGE_UPLOADS"] + '/'+image1.filename[:-4]+image2.filename[:-4]+'.png'))
            return send_file('./images/'+image1.filename[:-4]+image2.filename[:-4]+'.png')
